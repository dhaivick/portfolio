      ...
      <Grid>
        ...
        <Grid.Col md={10} lg={8}>
          <Text style={{ textAlign: "justify", textJustify: "inter-word" }}>
            ...
            programming languages and technologies, including JavaScript, React,
            and many more. I am constantly learning and exploring new
            technologies to expand my skillset and stay up-to-date with the
            latest industry trends.
            <br />
            <br />
            Throughout my career, I have worked on a variety of projects,
            ranging from small web applications to large-scale enterprise
            software systems. I pride myself on my attention to detail and my
            ...
            designers, and stakeholders to ensure that everyone's voices are
            heard and that we are all working towards a common goal.
            <br />
            <br />
            On this website, you will find examples of my work, my resume, and
            my blog, where I share my thoughts and insights on software
            development and technology. If you are interested in working with me
